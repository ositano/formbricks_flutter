...
import 'package:formbricks_flutter/src/survey/in_app/question_types/multiple_choice_single.dart';
...
void main() {
  ...
  setUp(() async {
    ...
    question = survey?.questions.firstWhere((question) => question.type == QuestionType.multipleChoiceSingle);
  });
  ...
  testWidgets('Presence of Checkboxes and texts', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: Scaffold(
          body: MultipleChoiceSingleQuestion(
            question: question!,
