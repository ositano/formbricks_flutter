...
import 'package:formbricks_flutter/src/survey/in_app/question_types/address_question.dart';
...
void main() {
  ...
  setUp(() async {
    ...
    question = survey?.questions.firstWhere((question) => question.type == QuestionType.address);
  });
